...
export default function Page() {
  ...
  return (
    <div>
      <div className='mobile-screen-login w-full h-[100vh] flex flex-col justify-start items-center text-[14px] pt-10'>
      ...
      <div className='w-full h-[100px] flex flex-col items-center justify-center text-[12px] flex-shrink-0'>
        <hr className='border border-gray-300 w-full mb-5' />
