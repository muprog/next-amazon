...
//               <div className='pt-1 absolute top-[-3px] left-3 text-[14px] text-orange-400 font-semibold'>
//                 {cartLength}
//               </div>
...
export default function Header() {
  ...
  const [openCart, setOpenCart] = useState(false) // openCart state controls message visibility
